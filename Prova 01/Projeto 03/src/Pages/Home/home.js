    ...
    return(
        <div class='principalHome'>
            <div class='conteinerTituloHome'>
                <h1 class='titulo'>Bem vindo a Super Express!</h1>
                <br/>
            </div>

            <div class='conteinerPrincipalHome'>
                <br/>
                <p class='mensagem'>Bem vindo ao site da <strong>Super Express</strong>, Navegue pelo site utilizando a barra de navegação acima e faça bom proveito</p>    
                <br/><br/><br/>
