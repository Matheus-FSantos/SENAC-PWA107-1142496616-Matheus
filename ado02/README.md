...
<section>
  ...
  <p>
    Espaço destinado para a entrega da primeira ADO (Atividade Avaliativa) da matéria de Programação Web do 2º semestre do curso de Análise e Desenvolvimento de Sistemas do Centro Universitário <a href="https://www.sp.senac.br/" target="_blank">SENAC</a> - São Paulo, ADO proposta para o estudo do JSX, que é uma extensão React para a linguagem JavaScript, e do hook useState
  </p>
</section>
